...
[![build status](https://img.shields.io/github/workflow/status/TA-wiah/paystack_pay/Build%20and%20Test)](https://github.com/TA-wiah/paystack_pay/actions?query=Build+and+test)
[![Coverage Status](https://coveralls.io/repos/github/TA-wiah/paystack_pay/badge.svg?branch=master)](https://coveralls.io/github/TA-wiah/paystack_pay?branch=master)
[![pub package](https://img.shields.io/pub/v/paystack_pay.svg)](https://pub.dartlang.org/packages/paystack_pay)


<p>
    <img src="https://raw.githubusercontent.com/TA-wiah/paystack_pay/master/screenshots/card_payment.png" width="200px" height="auto" hspace="20"/>
    <img src="https://raw.githubusercontent.com/TA-wiah/paystack_pay/master/screenshots/bank_payment.png" width="200px" height="auto" hspace="20"/>
</p>
...
## :rocket: Installation
To use this plugin, add `paystack_pay` as a [dependency in your pubspec.yaml file](https://flutter.io/platform-plugins/).
...
of [CheckoutResponse](https://pub.dev/documentation/paystack_pay/latest/paystack_pay/CheckoutResponse-class.html)
...
An [example project](https://github.com/TA-wiah/paystack_pay/tree/master/example) has been provided in this plugin.
Clone this repo and navigate to the **example** folder. Open it with a supported IDE or execute `flutter run` from that folder in terminal.

## :pencil: Contributing, :disappointed: Issues and :bug: Bug Reports
The project is open to public contribution. Please feel very free to contribute.
Experienced an issue or want to report a bug? Please, [report it here](https://github.com/TA-wiah/paystack_pay/issues). Remember to be as descriptive as possible.
