...
import 'package:paystack_pay/src/api/service/card_service.dart';
import 'package:paystack_pay/src/common/exceptions.dart';
import 'package:paystack_pay/src/common/my_strings.dart';
import 'package:paystack_pay/src/common/platform_info.dart';
import 'package:paystack_pay/src/common/string_utils.dart';
...
import 'package:paystack_pay/src/transaction/card_transaction_manager.dart';
...
class _Paystack {
  ...
  Future<CheckoutResponse> checkout(
    ...
    CheckoutResponse? response = await showDialog(
      ...
      context: context,
      builder:
          (BuildContext context) => new CheckoutWidget(
            publicKey: publicKey,
