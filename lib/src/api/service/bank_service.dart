...
import 'package:paystack_pay/src/api/service/base_service.dart';
...
import 'package:paystack_pay/src/common/extensions.dart';
...
class BankService with BaseApiService implements BankServiceContract {
  ...
  Future<TransactionApiResponse> chargeBank(
    BankChargeRequestBody? requestBody,
  ) async {
    var url =
  ...
  Future<TransactionApiResponse> _getChargeFuture(
    String url, {
    var fields,
  }) async {
