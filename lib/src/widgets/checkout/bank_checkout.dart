...
import 'package:paystack_pay/src/api/service/bank_service.dart';
import 'package:paystack_pay/src/api/service/contracts/banks_service_contract.dart';
import 'package:paystack_pay/src/common/paystack.dart';
import 'package:paystack_pay/src/models/bank.dart';
import 'package:paystack_pay/src/models/charge.dart';
import 'package:paystack_pay/src/models/checkout_response.dart';
import 'package:paystack_pay/src/transaction/bank_transaction_manager.dart';
import 'package:paystack_pay/src/widgets/buttons.dart';
import 'package:paystack_pay/src/widgets/checkout/base_checkout.dart';
import 'package:paystack_pay/src/widgets/checkout/checkout_widget.dart';
import 'package:paystack_pay/src/widgets/common/extensions.dart';
import 'package:paystack_pay/src/widgets/input/account_field.dart';
            ...
            case ConnectionState.waiting:
              widget = new Center(
                child: new Container(
                  ...
                  child: new CircularProgressIndicator(strokeWidth: 3.0),
                ),
              );
              break;
      ...
      child: new Form(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            _currentBank == null
                ? new Icon(Icons.account_balance, size: 35.0)
                : container,
            _currentBank == null ? new SizedBox(height: 20.0) : container,
            new Text(
              _currentBank == null
