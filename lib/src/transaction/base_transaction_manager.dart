...
import 'package:paystack_pay/src/models/transaction.dart';
import 'package:paystack_pay/src/widgets/birthday_widget.dart';
import 'package:paystack_pay/src/widgets/card_widget.dart';
import 'package:paystack_pay/src/widgets/otp_widget.dart';
import 'package:paystack_pay/src/widgets/pin_widget.dart';
...
abstract class BaseTransactionManager {
  ...
  Future<CheckoutResponse> getOtpFrmUI({
    ...
    String? otp = await showDialog<String>(
      ...
      barrierDismissible: false,
      builder:
          (BuildContext context) => new OtpWidget(
            message:
                message != null
                    ? message
                    : response!.displayText == null ||
                        response.displayText!.isEmpty
                    ? response.message
