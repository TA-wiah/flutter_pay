import 'package:paystack_pay/src/common/card_utils.dart';
...
class PaymentCard {
  ...
  bool validNumber(String? cardNumber) {
    ...
    var formattedNumber = cardNumber!.trim().replaceAll(
      new RegExp(r'[^0-9]'),
      '',
    );
...
abstract class CardType {
  ...
  static final fullPatternDinersClub = RegExp(
    r'^3(?:0[0-5]|[68][0-9])'
    r'[0-9]{11}$',
  );
  static final fullPatternDiscover = RegExp(r'^6(?:011|5[0-9]{2})[0-9]{12}$');
  static final fullPatternJCB = RegExp(
    r'^(?:2131|1800|35[0-9]{3})'
    r'[0-9]{11}$',
  );
  static final fullPatternVerve = RegExp(
    r'^((506(0|1))|(507(8|9))|(6500))[0-9]{12,15}$',
  );
  ...
  static final startingPatternJCB = RegExp(
    r'(2131)|(1800)(352[89])|(35[3-8]*[0-9])',
  );
